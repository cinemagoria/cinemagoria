<template>
  <section class="panel" aria-label="Catalogue search">
    <div class="panel__primary">
      ...
      <FilterSelect
        ...
        :options="sortOptions"
        fallback-label="Highly Rated (IMDb)"
      ...
      <div class="panel__actions">
        <button
          ...
          <span class="panel__toggle-text">Refine</span>
    ...
    <p v-if="!isActive" class="panel__hint">
      Pick a genre — or open <strong>Refine</strong> — to search the whole {{ typeMeta.catalogueLabel }} catalogue.
    </p>
    ...
    <div v-show="expanded" id="discover-refinements" class="panel__refinements">
      <div class="panel__grid">
        ...
        <div class="cell">
          <span class="cell__label">Release years</span>
          <div class="range">
            <input
              type="text"
              inputmode="numeric"
        ...
        <div class="cell">
          <span class="cell__label">Rating</span>
          <div class="range">
            <input
              type="text"
              inputmode="decimal"
