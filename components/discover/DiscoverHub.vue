  ...
  <div class="hub">
    ...
    <section v-if="hasFollowRows" class="hub__zone">
      <div class="hub__gutter">
        <div class="rule">
          <span class="rule__text">De lo que sigues</span>
    ...
    <section class="hub__zone">
      ...
      <p v-if="!curatedRows.length" class="hub__gutter hub__empty">
        Estas listas no están disponibles ahora mismo. La búsqueda del catálogo y las páginas de género siguen funcionando.
      </p>
    </section>
    ...
    <section class="hub__zone hub__zone--last">
      <div class="hub__gutter">
        <div class="rule">
          <span class="rule__text">Explorar por género</span>
          <span class="rule__line" aria-hidden="true"></span>
        </div>
