    ...
    <div :class="$style.right">
      ...
      <div :class="$style.stats">
        ...
        <div v-if="isLoggedIn" :class="$style.followSection">
            <h4 style="margin-top:2rem; font-size: 16px; font-weight:800; text-transform: uppercase;" class="section-title">Notifications</h4>
            <button 
    ...
    async toggleFollow() {
      ...
      try {
        if (this.isFollowing) {
          ...
          const response = await fetch(`https://cinemagoria-follows-746175915741.us-east1.run.app/follows/add`, {
            method: 'POST',
