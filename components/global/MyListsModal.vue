                  ...
                  <div :class="$style.cardContent">
                        ...
                        <div :class="$style.editFormContainer">
                            ...
                            <div :class="$style.privacyToggle" @click.stop="editForm.is_public = !editForm.is_public">
                               <div :class="$style.privacyOption">
                                   <span :class="!editForm.is_public ? $style.privacyActive : ''">Privada</span>
                                   <div :class="$style.toggleSwitch">
                                       <div :class="[$style.toggleKnob, editForm.is_public ? $style.toggleOn : '']"></div>
                                   </div>
                                   <span :class="editForm.is_public ? $style.privacyActive : ''">Pública</span>
                               </div>
                            </div>

                            <div :class="$style.editActions">
                                 <button @click.stop="cancelEdit" :class="$style.cancelBtn">Cancelar</button>
                                 <button @click.stop="saveEdit" :class="$style.saveBtn">Guardar</button>
                            </div>
                        </div>
                    </template>
                    ...
                    <template v-else>
                        ...
                        <div v-if="!itemToAdd && !itemsToAdd" :class="$style.actionButtons">
                           <button @click.stop="startEdit(list)" :class="$style.editButton">Editar</button>
                           <button @click.stop="deleteList(list)" :class="$style.deleteButton">Eliminar</button>
                        </div>
                    </template>
                  </div>
                </div>
