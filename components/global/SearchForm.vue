        ...
        <div class="field-wrapper">
          <div :class="$style.field">
            <button 
              ...
              @click="goBack">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="1.5" d="m16.5 20.5-9-8.5 9-8.5"/></svg>
            </button>
            <input
              id="search"
              ref="input"
