    ...
    <transition name="modal-fade">
      <div v-if="open" class="share-overlay" @click.self="close">
        <div class="share-card" role="dialog" aria-modal="true" aria-labelledby="share-title">
          ...
          <h2 id="share-title" class="share-title">Compartir este artículo</h2>
          <p class="share-subtitle">Mandalo a alguien, publicalo o copiá el enlace.</p>

          <!-- Link + copy -->
          <div class="field-group">
            <label class="field-label" for="share-link-input">Enlace</label>
            <div class="link-row">
              <input
                id="share-link-input"
                ref="linkInput"
              ...
              <button
                ...
                @click="copyLink"
                :aria-label="copySuccess ? 'Copiado' : 'Copiar enlace'"
              >
          ...
          <!-- Editable title -->
          <div class="field-group">
            <label class="field-label" for="share-custom-title">Título</label>
            <input
          ...
          <!-- Editable message -->
          <div class="field-group">
            <label class="field-label" for="share-custom-message">Mensaje</label>
            <textarea
          ...
          <!-- Social buttons -->
          <div class="field-group">
            <label class="field-label">Compartir en</label>
            <div class="social-row">
              <button
                ...
                @click="nativeShare"
                aria-label="Compartir con tu dispositivo"
                title="Compartir desde el sistema"
              >
                <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
function buildDefaults() {
  const title = props.articleTitle || 'este artículo'
  customTitle.value = `Te comparto "${title}" de Cinemagoria`
