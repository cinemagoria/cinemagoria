    ...
    <div :class="$style.panel">
      <div :class="$style.top">
        <div :class="$style.brand">
          <nuxt-link to="/" :class="$style.lockup" aria-label="Inicio">
            <img src="/icons/icon-medium.png" alt="" width="36" height="36" loading="lazy" />
            <span :class="$style.wordmark">Cinemagoria</span>
          </nuxt-link>
          <p :class="$style.tagline">Películas, series, festivales, premios y disponibilidad en streaming &mdash; en un solo lugar.</p>
          <div :class="$style.socials">
            ...
            <a href="mailto:hello@cinemagoria.com" :class="$style.socialBtn" aria-label="Correo" title="Correo">
            ...
            <a href="/feed" target="_blank" rel="noopener" :class="$style.socialBtn" aria-label="Feed RSS" title="Feed RSS">
        ...
        <nav :class="$style.columns" aria-label="Pie de página">
          <div :class="$style.column">
            <h4 :class="$style.heading">Explorar</h4>
            <ul :class="$style.links">
              <li><nuxt-link to="/movie">Películas</nuxt-link></li>
              <li><nuxt-link to="/tv">Series</nuxt-link></li>
              <li><nuxt-link to="/festival">Festivales</nuxt-link></li>
      ...
      <div :class="$style.bottom">
        <div :class="$style.legal">
          ...
          <nuxt-link to="/usage-policies">Privacidad y Términos</nuxt-link>
        ...
        <div :class="$style.meta">
          ...
          <div v-if="!isLoggedIn" :class="$style.langSwitch" role="group" aria-label="Idioma">
