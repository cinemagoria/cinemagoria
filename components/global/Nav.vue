    ...
    <ul class="nolist">
      <li>
        <nuxt-link
          ...
          <img src="/icons/icon-medium.png" alt="Home" class="home-icon" :class="$style.navIcon" />
      ...
      <li>
        ...
        <span :class="$style.navLabel">Discover</span>
        </nuxt-link>
      </li>
      <li>
        <nuxt-link
          ...
          aria-label="News"
          @click.native="clearSearchBeforeNavigate">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" :class="$style.navIcon"><path d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" /></svg>
        <span :class="$style.navLabel">News</span>
        </nuxt-link>
      </li>
      ...
      <li v-if="!isLoggedIn">
        <nuxt-link exact to="/login" aria-label="Sign In" @click.native="clearSearchBeforeNavigate">
          <img src="/icons/icon-login.png" alt="Login" :class="$style.navIcon" />
        <span :class="$style.navLabel">Sign in</span>
        </nuxt-link>
      </li>
      <li v-else>
        <a 
        ...
        <span :class="$style.navLabel">Watchlist</span>
        </a>
      </li>
    </ul>
        ...
        <div :class="$style.menuContent">
            <div v-if="listsPage === 1" :class="$style.menuItem" @click="navigateFromMenu('/watchlist')">
                <div :class="$style.itemIcon">
                   <img src="/placeholders/empty-list-placeholder.webp" :class="$style.placeholderImgNav" alt="Watchlist" />
                </div>
