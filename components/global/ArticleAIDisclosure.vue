  ...
  <div class="ai-disclosure">
    ...
    <div class="disclosure-body">
      <p class="disclosure-text">
        Este artículo fue generado con la asistencia de IA. Pueden existir errores o imprecisiones. Si se detecta algún error, puede ser reportado para su corrección.
      </p>
            ...
            <transition name="state-fade" mode="out-in">
              <div v-if="state === 'form'" key="form" class="state-block">
                ...
                <p class="report-subtitle">
                  Ayudanos a corregir este artículo. Elegí qué está mal y contanos un poco más.
                </p>
                ...
                <form @submit.prevent="submitReport" class="report-form">
                  ...
                  <div class="field-group">
                    ...
                    <textarea
                      ...
                      placeholder="Describí el error con el mayor detalle posible — cuanto más específico, más rápido lo corregimos."
                      rows="4"
                      maxlength="2000"
                      required
                    ></textarea>
              ...
              <div v-else-if="state === 'success'" key="success" class="state-block success-block">
                ...
                <p class="success-text">
                  El reporte fue enviado. Será revisado y, si corresponde, el artículo será corregido.
                </p>
              </div>
            </transition>
          </div>
