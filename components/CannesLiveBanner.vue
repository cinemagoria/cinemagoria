<template>
  <nuxt-link
    ...
    class="cannes-banner"
    role="banner"
    aria-label="Cannes 2026 — explorá la cobertura"
  >
    <!-- Fondo: cinemagoria-dark con glows sutiles -->
    <svg
    ...
    >
      <defs>
        <linearGradient id="cannes-bg-grad" x1="0" y1="0" x2="1" y2="0">
    ...
    <div class="cannes-banner__inner">
      <!-- Logo oficial de Cannes (blanco, fondo transparente) -->
      <svg
      ...
      <div class="cannes-banner__info">
        <div class="cannes-banner__pill">
          <span class="cannes-banner__pill-dot" aria-hidden="true" />
          79<sup class="cannes-banner__pill-sup">ª</sup> EDICIÓN · 12–23 MAYO · 2026
        </div>
        <div class="cannes-banner__tagline" aria-hidden="true">
          Selección oficial, secciones paralelas y programación diaria —
          <span class="cannes-banner__tagline-accent">descubrí la cobertura completa</span>
        </div>
      </div>

      <span class="cannes-banner__cta" aria-label="Abrir cobertura de Cannes">
        Explorar
      </span>
    </div>
  </nuxt-link>
...
.cannes-banner__pill-dot {
  ...
  animation: cannes-pill-pulse 1.8s ease-in-out infinite;
}

@keyframes cannes-pill-pulse {
  0%, 100% { opacity: 1; }
  50%      { opacity: 0.55; }
}
