<template>
  <nuxt-link
    ...
    class="cannes-banner"
    role="banner"
    aria-label="Cannes 2026 — explore the coverage"
  >
    ...
    <div class="cannes-banner__inner">
      ...
      <div class="cannes-banner__info">
        <div class="cannes-banner__pill">
          ...
          79<sup class="cannes-banner__pill-sup">TH</sup> EDITION · MAY 12–23 · 2026
        </div>
        <div class="cannes-banner__tagline" aria-hidden="true">
          Official selection, parallel sections &amp; daily schedule —
          <span class="cannes-banner__tagline-accent">explore the full coverage</span>
        </div>
      </div>

      <span class="cannes-banner__cta" aria-label="Open Cannes coverage">
        Explore
      </span>
    </div>
  </nuxt-link>
