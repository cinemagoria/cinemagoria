<template>
  <nuxt-link
    ...
    role="banner"
    aria-label="Fantasia 2026 — explore the coverage"
  >
    <svg
    ...
    <div class="fantasia-banner__inner">
      ...
      <div class="fantasia-banner__info">
        ...
        <div class="fantasia-banner__tagline" aria-hidden="true">
          ...
          <span class="fantasia-banner__tagline-accent">explore the full coverage</span>
        </div>
      </div>

      <span class="fantasia-banner__cta" aria-label="Open Fantasia coverage">
        Explore
      </span>
    </div>
  </nuxt-link>
