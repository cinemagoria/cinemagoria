...
const FESTIVALS = [
  {
    ...
    tagline: 'Horror premieres, five screens & daily schedule —',
    end: new Date('2026-08-31T23:00:00Z'),
  },
  {
    key: 'tiff',
    to: '/festival/tiff-2026',
    label: 'Toronto International Film Festival 2026',
    ...
    tagline: 'World premieres, awards-season launch & daily schedule —',
    end: new Date('2026-09-21T04:00:00Z'),
  },
  {
    key: 'venice',
    to: '/festival/venice-2026',
    label: 'Venice International Film Festival 2026',
    ...
    editionSuffix: 'RD',
    dates: 'SEP 2 – 12 · 2026',
    tagline: 'Golden Lion race, parallel sections & daily schedule —',
