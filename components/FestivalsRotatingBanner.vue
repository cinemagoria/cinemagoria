...
const FESTIVALS = [
  {
    ...
    edition: '70ª',
    editionSuffix: '',
    dates: '7 – 18 OCTUBRE · 2026',
    tagline: 'Galas, secciones competitivas y programación diaria —',
    end: new Date('2026-10-18T23:00:00Z'),
  },
  {
    key: 'biff',
    to: '/festival/biff-2026',
    label: 'Festival Internacional de Cine de Busan 2026',
    logo: '/festivals/biff/biff_logo_live_banner_2026.png',
    pattern: '/festivals/biff/biff_pattern_live_banner_2026.png',
    invertLogo: true,
    edition: '31ª',
    editionSuffix: '',
    dates: '6 – 15 OCTUBRE · 2026',
    tagline: 'Estrenos asiáticos, retrospectivas y programación diaria —',
  ...
  },
  {
    ...
    tagline: 'Estrenos fantásticos, Midnight X-treme y programación diaria —',
