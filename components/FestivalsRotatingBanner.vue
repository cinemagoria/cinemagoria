<template>
  <nuxt-link
    ...
    role="banner"
    :aria-label="`${activeFestival.label} — explore the coverage`"
  >
    <svg
      ...
      <div class="fest-banner__inner">
        ...
        <div class="fest-banner__info">
          <div class="fest-banner__pill">
            ...
            <span class="fest-banner__pill-text">
              <span class="fest-banner__pill-edition">
                {{ festival.edition }}<sup v-if="festival.editionSuffix" class="fest-banner__pill-sup">{{ festival.editionSuffix }}</sup> EDITION
              </span>
          ...
          <div class="fest-banner__tagline" aria-hidden="true">
            {{ festival.tagline }}
            <span class="fest-banner__tagline-accent">explore the full coverage</span>
          </div>
        </div>
...
const FESTIVALS = [
  {
    key: 'bfi',
    to: '/festival/bfi-2026',
    label: 'BFI London Film Festival 2026',
    logo: '/festivals/bfi/bfi_logo_live_banner_2026.png',
    pattern: '/festivals/bfi/bfi_pattern_live_banner_2026.png',
    invertLogo: true,
    edition: '70',
    editionSuffix: 'TH',
    dates: 'OCT 7 – 18 · 2026',
    tagline: 'Galas, competition strands & daily schedule —',
    end: new Date('2026-10-18T23:00:00Z'),
  },
  {
    key: 'biff',
    to: '/festival/biff-2026',
    label: 'Busan International Film Festival 2026',
    logo: '/festivals/biff/biff_logo_live_banner_2026.png',
    pattern: '/festivals/biff/biff_pattern_live_banner_2026.png',
    invertLogo: true,
    edition: '31',
    editionSuffix: 'ST',
    dates: 'OCT 6 – 15 · 2026',
    tagline: 'Asian premieres, retrospectives & daily schedule —',
    end: new Date('2026-10-15T15:00:00Z'),
  },
  {
    key: 'sitges',
    to: '/festival/sitges-2026',
    label: 'Sitges Film Festival 2026',
    logo: '/festivals/sitges/sitges_logo_live_banner_2026.png',
    pattern: '/festivals/sitges/sitges_pattern_live_banner_2026.png',
    invertLogo: true,
    edition: '59',
    editionSuffix: 'TH',
    dates: 'OCT 8 – 18 · 2026',
    tagline: 'Fantastic premieres, Midnight X-treme & daily schedule —',
    end: new Date('2026-10-18T22:00:00Z'),
  },
];
