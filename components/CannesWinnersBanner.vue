<template>
  <nuxt-link
    ...
    class="cannes-banner"
    role="banner"
    aria-label="Cannes 2026 winners — explore the palmarès"
  >
    ...
    <div class="cannes-banner__inner">
      ...
      <div class="cannes-banner__ticker-wrap" aria-hidden="true">
        ...
        <div v-else class="cannes-banner__tagline">
          The 79<sup>th</sup> Festival de Cannes winners —
          <span class="cannes-banner__tagline-accent">explore the full palmarès</span>
        </div>
      </div>

      <!-- Right: CTA -->
      <span class="cannes-banner__cta" aria-label="Open Cannes winners">
        Explore
      </span>
    </div>
  </nuxt-link>
