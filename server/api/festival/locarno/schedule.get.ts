...
export default defineEventHandler(async (event) => {
    ...
    try {
        const sql = `
            ...
            WHERE f.festival_name = 'Locarno Film Festival' AND f.festival_year = 2026
        ...
        console.error('Locarno Film Festival 2026 Schedule Fetch Error:', error)
        throw createError({
            statusCode: 500,
            statusMessage: `Failed to fetch Locarno Film Festival 2026 schedule: ${error.message}`,
        })
    }
})
