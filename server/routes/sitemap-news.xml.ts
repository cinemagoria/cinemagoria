...
export default defineEventHandler(async (event) => {
  ...
  const altBaseUrl = 'https://cinemagoria.com'
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"></urlset>`
  ...
  try {
    ...
    <xhtml:link rel="alternate" hreflang="en" href="${altBaseUrl}/news/${row.slug}"/>
    <xhtml:link rel="alternate" hreflang="es" href="${baseUrl}/news/${row.slug}"/>
    <xhtml:link rel="alternate" hreflang="x-default" href="${altBaseUrl}/news/${row.slug}"/>
