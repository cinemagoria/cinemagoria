...
> Generated by [Gitset](https://gitset.dev) Knowledge Mapper at 603fdc6. Derived from source code, manifests and CI configuration — not from existing prose docs.
...
Validation: 2 unresolved reference(s) flagged by the local validator
