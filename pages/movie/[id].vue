  ...
  <main class="main">
    ...
    <template v-else>
      ...
      <template v-if="activeMenu === 'sinopsis'">
        <MovieInfo v-if="item && item.id" :item="item" @open-releases="activeMenu = 'estrenos'" @show-awards="activeMenu = 'premios'" :reviews-prop="reviews" :oscars="awardsData.oscars" :golden-globes="awardsData.goldenGlobes">
