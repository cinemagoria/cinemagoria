<template>
  <main class="pc-page">
    ...
    <header class="page-header pc-header">
      <span class="pc-eyebrow">Catálogo</span>
      <h1 class="page-title">Productoras</h1>
      <p class="page-subtitle">
        Cada estudio, sello y casa productora registrada en el catálogo. Busca por nombre o salta directamente a una letra.
      </p>
    </header>

    <div class="pc-gutter">
      <section class="pc-panel" aria-label="Filtrar productoras">
        <div class="pc-search">
          ...
          <input
            ...
            aria-label="Buscar productoras">
          <button v-if="query" type="button" class="pc-search__clear" aria-label="Limpiar búsqueda" @click="query = ''">
        ...
        <div class="pc-alpha" role="group" aria-label="Filtrar por inicial">
          <button
            type="button"
            class="pc-alpha__key"
    ...
    <section v-if="showPopular" class="pc-gutter pc-zone">
      <div class="rule">
        <span class="rule__text">Más seguidas</span>
    ...
    <section class="pc-gutter pc-zone pc-zone--last">
      <div class="rule">
        ...
        <button v-if="hasFilters" type="button" class="pc-reset" @click="resetFilters">Restablecer</button>
      </div>
      ...
      <p v-else class="pc-empty">
        Ninguna productora coincide con <strong>{{ query || letter }}</strong>.
      </p>

      <div v-if="hasMore" class="pc-more">
        <button type="button" class="pc-more__btn" @click="page += 1">Cargar más</button>
        <span class="pc-more__meta">{{ visible.length.toLocaleString('es-ES') }} de {{ filtered.length.toLocaleString('es-ES') }}</span>
      </div>
    </section>
  </main>
</template>
