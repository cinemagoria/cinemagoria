            ...
            <div class="header-actions-left">
              ...
              <div class="filter-switch-three">
                ...
                <button :class="['filter-btn', 'icon-on-mobile', { active: viewMode === 'activity' }]" @click="switchToActivity">
                  <span class="btn-text">Actividad</span>
          ...
          <div 
            ...
            <div class="notification-tabs">
              ...
              <button 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M20 6 9 17l-5-5"/></svg>
              </button>
            </div>
          </div>
        </div>
          ...
          <div class="delete-modal">
            ...
            <div class="delete-modal-content">
              <div class="exclamation-svg">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none" stroke="#8be9fd" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="lucide lucide-circle-alert-icon lucide-circle-alert" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg>
              </div>
...
export default {
  head () {
    return {
      title: 'Cinemagoria - Centro de Notificaciones.',
      meta: [
        { hid: 'og:title', property: 'og:title', content: 'Centro de Notificaciones' },
