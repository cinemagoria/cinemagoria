        ...
        <div v-else class="notifications-list">
          <div 
            ...
            <div 
              ...
              <img 
                v-if="notification.person_id && (notification.profile_path || isStreamingProvider(notification.person_id))" 
                :src="getProfileImage(notification)" 
                :alt="notification.person_name"
                :class="['person-profile-image', { 'company-logo': isCompany(notification.person_id) || isStreamingProvider(notification.person_id) }]">
  ...
  methods: {
    handlePersonClick(notification) {
      ...
      if (notification.person_id) {
        if (this.isStreamingProvider(notification.person_id)) {
    ...
    async fetchFollowingCount() {
      ...
      isStreamingProvider(id) {
        return STREAMING_PROVIDERS.some(p => p.id === id);
      },
