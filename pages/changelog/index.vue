  ...
  <main class="main">
    ...
    <nav class="navbar navbar-welcome">
      ...
      <h2 class="title-secondary" style="color: rgb(172, 175, 181); font-size: 14px; max-width: 600px; margin: 20px auto 0;">
        Últimas actualizaciones y mejoras de Cinemagoria.
      </h2>
    </nav>
    ...
    <div class="changelog-section">
      ...
      <div v-else-if="error" class="error-container">
        <p>{{ error }}</p>
        <button @click="fetchReleases" class="retry-btn">Reintentar</button>
      </div>
        ...
        <div v-for="release in releases" :key="release.id" class="release-card">
          <div class="release-header">
            ...
            <a :href="release.html_url" target="_blank" class="github-btn">
              Ver en GitHub
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6m4-3h6v6m-11 5L21 3"/></svg>
            </a>
          </div>
