    ...
    <div class="auth-success-card">
      <transition name="fade" mode="out-in">
        ...
        <div v-else-if="error" key="error" class="state-container error-state">
          ...
          <h2 class="error-text">Autenticación Fallida</h2>
        ...
        <div v-else key="success" class="state-container success-state">
          ...
          <p class="subtitle">Tu cuenta ha sido verificada con éxito.</p>
          
          <div class="redirect-container">
            <div class="progress-bar-wrapper">
               <div class="progress-bar"></div>
            </div>
            <p class="redirect-message">Redireccionando en {{ countdown }} segundos...</p>
          </div>
        </div>
      </transition>
    </div>
