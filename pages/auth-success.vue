    ...
    <div class="auth-success-card">
      <transition name="fade" mode="out-in">
        <div v-if="loading" key="loading" class="state-container loading-state">
          ...
          <h2 class="glow-text">Authenticating</h2>
          <p class="subtitle">Securely processing your information...</p>
        </div>
        ...
        <div v-else key="success" class="state-container success-state">
          ...
          <h2 class="glow-text">Welcome, <span class="highlight">{{ name }}</span>!</h2>
          ...
          <div class="redirect-container">
            ...
            <p class="redirect-message">Redirecting you in {{ countdown }} seconds...</p>
          </div>
        </div>
      </transition>
    </div>
