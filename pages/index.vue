...
// ─── Cannes 2026 — ventanas de visibilidad ───────────────────────────────────
// En vivo: hasta el cierre del festival — 23 may 2026 23:59 Francia (CEST → 21:59 UTC)
const CANNES_LIVE_EXPIRY = new Date('2026-05-23T21:59:00Z');
// Ganadores: desde la tarde del palmarès hasta después del festival
