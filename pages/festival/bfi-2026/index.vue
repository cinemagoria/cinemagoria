    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://whatson.bfi.org.uk/lff/Online/default.asp" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/bfi/bfi_backdrop_2026_es.webp"
              alt="Backdrop del BFI London Film Festival 2026"
      ...
      <div v-else>
        ...
        <div v-if="activeTab === 'schedule'" class="schedule-container">
          ...
          <div v-if="schedule.length === 0" class="rollout-banner">
            ...
            <div class="rollout-banner__copy">
              <h3>Horarios por publicar</h3>
              <p>El festival aún no publicó los horarios oficiales de las funciones. La información de cada proyección aparecerá aquí en cuanto esté disponible.</p>
            </div>
          </div>
...
<!-- Slide 0: General Information -->
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Edición:</strong> 70.ª del BFI London Film Festival</p>
                    <p class="carousel-desc"><strong>Fechas:</strong> 7 – 18 de octubre de 2026</p>
                    <p class="carousel-desc"><strong>Sede:</strong> Londres, Reino Unido</p>
                    <p class="carousel-desc"><strong>Sitio oficial:</strong> <a href="https://whatson.bfi.org.uk/lff/Online/default.asp" target="_blank" class="accent-link">whatson.bfi.org.uk</a></p>
                    <p class="carousel-desc">El evento de cine abierto al público más grande del Reino Unido, organizado por el British Film Institute alrededor del BFI Southbank. Su programa se clasifica por partida doble: por un lado las competencias y galas, por el otro los ejes temáticos — Love, Debate, Laugh, Dare, Thrill, Cult, Journey, Create —, así que un mismo título suele pertenecer a varios a la vez. Junto a los largometrajes reúne una de las selecciones de cortos y de imagen en movimiento más grandes del circuito.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Entrada general, desde</span><span class="price-value">£10</span></li>
                      <li><span class="price-label">Cargo por gestión</span><span class="price-value">£1</span></li>
                      <li><span class="price-label">Menores de 25, cualquier función</span><span class="price-value">£6</span></li>
                      <li><span class="price-label">Membresía anual</span><span class="price-value">£44</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Menores de 25:</strong> el registro es gratuito y deja cualquier entrada del festival en £6, galas incluidas.</p>
                    <p class="carousel-desc"><strong>Venta:</strong> los socios compran una semana antes que el público general y no pagan cargo por gestión.</p>
                    <p class="carousel-desc"><strong>Premios del público:</strong> la votación abre el primer día del festival.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>BFI Southbank</strong><span>Salas NFT1 a NFT4 · sede central</span></div>
                      ...
                      <div class="venue-item"><strong>Vue West End</strong><span>EPIC 1 y 2 · Leicester Square</span></div>
                      <div class="venue-item"><strong>Curzon Soho</strong><span>Salas 1 a 3</span></div>
                      <div class="venue-item"><strong>Prince Charles Cinema</strong><span>Sala de abajo</span></div>
                      <div class="venue-item"><strong>ICA</strong><span>Sala 1 · The Mall</span></div>
                    </div>
                    <p class="carousel-desc">Trece salas repartidas en siete sedes. La pestaña de horarios lista cada función por día, con la sala exacta.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 3">
                    ...
                    <div class="section-glossary">
                      <div class="section-glossary-item"><strong>Galas</strong><span>Las presentaciones principales, incluidas las noches de apertura y cierre.</span></div>
                      <div class="section-glossary-item"><strong>Presentaciones especiales</strong><span>Eventos únicos, restauraciones y performances en vivo, fuera de las competencias.</span></div>
                      <div class="section-glossary-item"><strong>Competencia oficial</strong><span>La sección competitiva principal, que define el premio mayor del festival.</span></div>
                      <div class="section-glossary-item"><strong>Competencia ópera prima</strong><span>Primeras películas que compiten por el Sutherland Award.</span></div>
                      <div class="section-glossary-item"><strong>Competencia documental</strong><span>Largometrajes de no ficción en competencia.</span></div>
                      <div class="section-glossary-item"><strong>Competencia de cortos</strong><span>Cortometrajes nominados al premio de cortometraje del festival.</span></div>
                      <div class="section-glossary-item"><strong>Love</strong><span>Romance e intimidad, en todo su esplendor.</span></div>
                      <div class="section-glossary-item"><strong>Debate</strong><span>Historias que abren conversaciones.</span></div>
                      <div class="section-glossary-item"><strong>Laugh</strong><span>De la comedia romántica desatada a la sátira más filosa.</span></div>
                      <div class="section-glossary-item"><strong>Dare</strong><span>Obras que corren los límites formales y políticos.</span></div>
                      <div class="section-glossary-item"><strong>Thrill</strong><span>Cine de género, del vértigo puro a la tensión lenta.</span></div>
                      <div class="section-glossary-item"><strong>Cult</strong><span>Lo inclasificable y alucinado, más fantasía, ciencia ficción y terror.</span></div>
                      <div class="section-glossary-item"><strong>Journey</strong><span>Historias que corren el punto de vista.</span></div>
                      <div class="section-glossary-item"><strong>Create</strong><span>La electricidad del proceso creativo.</span></div>
                      <div class="section-glossary-item"><strong>Experimenta</strong><span>Artistas e imagen en movimiento, tanto largos como programas de cortos.</span></div>
                      <div class="section-glossary-item"><strong>Programas de cortos</strong><span>Agrupaciones curadas de cortometrajes, proyectadas juntas en una misma función.</span></div>
                      <div class="section-glossary-item"><strong>Family</strong><span>Películas para chicos, y para grandes con espíritu de chico.</span></div>
                      <div class="section-glossary-item"><strong>Archivo</strong><span>Restauraciones y redescubrimientos de la historia del cine.</span></div>
                      <div class="section-glossary-item"><strong>Expanded</strong><span>Realidad extendida, instalaciones inmersivas y videojuegos.</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
const CATEGORY_LABELS = {
    ["Galas"]: "Galas",
    ["Special Presentations"]: "Presentaciones especiales",
    ["Official Competition"]: "Competencia oficial",
    ["First Feature Competition"]: "Competencia ópera prima",
    ["Documentary Competition"]: "Competencia documental",
    ["Short Film Competition"]: "Competencia de cortos",
    ["Love"]: "Love",
    ["Debate"]: "Debate",
    ["Laugh"]: "Laugh",
    ["Dare"]: "Dare",
    ...
    ["Short Film Programme"]: "Programas de cortos",
    ["Family"]: "Family",
    ["Archive"]: "Archivo",
    ["Expanded"]: "Expanded",
    OTHER: "Otros",
...
onMounted(async () => {
    try {
        const [filmsData, scheduleData, awardsData] = await Promise.all([
            ...
            $fetch('/api/festival/bfi/schedule').catch(() => ({ results: [] })),
