    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://iffr.com/en/programme/2026" target="_blank" class="hero-backdrop">
            <img 
              src="/rotterdam_backdrop_2026_es.webp" 
      ...
      <div class="switcher-container">
        ...
        <div class="segmented-control">
            ...
            <label for="tab-films" @click="activeTab = 'films'">Peliculas</label>
...
const formatDate = (dateStr) => {
    ...
    // Use 'es-ES' for Spanish locale formatting
