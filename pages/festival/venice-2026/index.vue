    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.labiennale.org/en/cinema/2026" target="_blank" rel="noopener noreferrer" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/venice/venice_backdrop_2026_eng.webp"
              alt="Venice Film Festival 2026"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://www.labiennale.org/en/cinema/2026" target="_blank" rel="noopener noreferrer" class="accent-link">labiennale.org/en/cinema/2026</a></p>
                    <p class="carousel-desc"><strong>Dates:</strong> September 2 – 12, 2026, on the Lido di Venezia.</p>
                    <p class="carousel-desc">The <strong>Venice International Film Festival</strong> (La Biennale di Venezia) is the oldest film festival in the world, directed by <strong>Alberto Barbera</strong>. The 83rd edition opens with Danny Boyle's <em>Ink</em> and awards the Golden Lion at closing night. <strong>Maggie Gyllenhaal</strong> presides over the Venezia 83 main-competition jury.</p>
                    <p class="carousel-desc">Alongside the official Biennale sections (Venezia 83, Orizzonti, Fuori Concorso, Venezia Spotlight, Film on Films), two independently organized sidebars run in parallel: <strong>Giornate degli Autori</strong> (Venice Days) and <strong>Critics' Week</strong> (SIC).</p>
                  </template>

                  <!-- Slide 1: Tickets & Accreditation -->
                  <template v-if="infoSlide === 1">
                    <div class="carousel-card-header">
                      ...
                      <h3>Tickets &amp; Accreditation</h3>
                    </div>
                    <ul class="price-list">
                      <li><span class="price-label">Sala Grande — Afternoon Screening</span><span class="price-value">€15</span></li>
                      <li><span class="price-label">Sala Grande — Evening Gala</span><span class="price-value">€50</span></li>
                      <li><span class="price-label">Single Ticket — Other Theatres</span><span class="price-value">€15–20</span></li>
                      <li><span class="price-label">Cinema Accreditation — Early Bird</span><span class="price-value">€80</span></li>
                      <li><span class="price-label">Cinema Accreditation — Full Fee</span><span class="price-value">€95</span></li>
                      <li><span class="price-label">Industry Accreditation</span><span class="price-value">€200–350</span></li>
                    </ul>
                    <p class="carousel-desc">Theatre subscriptions went on sale online at labiennale.org on July 23, 2026; single tickets follow from mid-August. Cinema Accreditation (open to the public and students alike) runs €80 early bird or €95 full fee, valid for the entire festival.</p>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Palazzo del Cinema — Sala Grande</strong><span>Main venue, 1,032 seats — Lido di Venezia</span></div>
                      <div class="venue-item"><strong>Palazzo del Cinema — Sala Zorzi &amp; Pasinetti</strong><span>48 &amp; 119 seats — official selection annexes</span></div>
                      <div class="venue-item"><strong>Giornate degli Autori &amp; Critics' Week</strong><span>Independent venues on the Lido</span></div>
                    </div>
                    <p class="carousel-desc">The Palazzo del Cinema sits at Lungomare Marconi, on the Lido di Venezia, reachable from the city center by vaporetto (water bus). Giornate degli Autori and Critics' Week run their own screenings and events at separate venues on the Lido, alongside the official Biennale program.</p>
                  </template>
                </div>
              </transition>
            </div>
...
const CATEGORY_LABELS_EN = {
    'VENEZIA 83 CONCORSO': 'Venezia 83 (Competition)',
    'FUORI CONCORSO - FICTION': 'Fuori Concorso – Fiction',
    'FOURI CONCORSO - NON FICTION': 'Fuori Concorso – Non-Fiction',
    'ORIZZONTI CONCORSO': 'Orizzonti (Competition)',
    'ORIZZONTI SHORT FILMS - CONCORSO': 'Orizzonti Short Films – Concorso',
    'ORIZZONTI SHORT FILMS - FOURI CONCORSO': 'Orizzonti Short Films – Fuori Concorso',
...
onMounted(async () => {
    try {
        const [filmsData, sched, awardsData] = await Promise.all([
            ...
            $fetch('/api/festival/venice/schedule').catch(() => ({ results: [] })),
