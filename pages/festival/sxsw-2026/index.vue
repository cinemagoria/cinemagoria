    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.sxsw.com/festivals/film/" target="_blank" class="hero-backdrop">
            <img 
              src="/festivals/sxsw/sxsw_backdrop_2026_eng.webp" 
              alt="SXSW Backdrop"
            />
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Dates:</strong> March 12 – March 18, 2026</p>
                    <p class="carousel-desc"><strong>Location:</strong> Austin, Texas</p>
                    <p class="carousel-desc">Access to film screenings and sessions is <strong>capacity-based</strong> and operates through reservations and walk-up entry. Must arrive at least <strong>30 minutes before</strong> the event. Recommended: <strong>40 minutes before screenings</strong>.</p>
                  </template>

                  <!-- Slide 1: Badges & Pricing -->
                  <template v-if="infoSlide === 1">
                    <div class="carousel-card-header">
                      ...
                      <h3>Badges &amp; Pricing</h3>
                    </div>
                    <ul class="price-list">
                      <li><span class="price-label">Platinum Badge (all-access)</span><span class="price-value">~$1,135 – $1,495</span></li>
                      ...
                      <li><span class="price-label">Music Festival Wristbands</span><span class="price-value">from $149</span></li>
                    </ul>
                    <p class="carousel-desc">Early bird discounts available. Group discounts (15+ people): 10–20% off.</p>
                  </template>

                  <!-- Slide 2: Festival Venues -->
                  <template v-if="infoSlide === 2">
                    <div class="carousel-card-header">
                      ...
                      <h3>Festival Venues</h3>
                    </div>
                    <p class="carousel-desc">Screenings take place across multiple venues in downtown Austin. Shuttle services available for badgeholders.</p>
