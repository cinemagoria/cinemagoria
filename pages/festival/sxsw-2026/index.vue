  ...
  <main class="main">
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.sxsw.com/festivals/film/" target="_blank" class="hero-backdrop">
            <img 
              src="/festivals/sxsw/sxsw_backdrop_2026_es.webp" 
              alt="Fondo SXSW"
            />
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Fechas:</strong> 12 al 18 de marzo de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Austin, Texas</p>
                    <p class="carousel-desc">El acceso a funciones y sesiones depende de la <strong>capacidad</strong> y funciona mediante reservas y acceso por orden de llegada. Llegar al menos <strong>30 minutos antes</strong>. Recomendado: <strong>40 minutos antes para proyecciones</strong>.</p>
                  </template>

                  <!-- Slide 1: Credenciales y Precios -->
                  <template v-if="infoSlide === 1">
                    <div class="carousel-card-header">
                      ...
                      <h3>Credenciales y Precios</h3>
                    </div>
                    <ul class="price-list">
                      <li><span class="price-label">Platinum Badge (acceso total)</span><span class="price-value">~$1.135 – $1.495</span></li>
                      <li><span class="price-label">Interactive Badge</span><span class="price-value">~$785 – $1.495</span></li>
                      <li><span class="price-label">Film &amp; TV Badge</span><span class="price-value">~$600 – $1.225</span></li>
                      <li><span class="price-label">Music Badge</span><span class="price-value">~$475 – $895</span></li>
                      <li><span class="price-label">Wristbands de música</span><span class="price-value">desde $149</span></li>
                    </ul>
                    <p class="carousel-desc">Descuentos early bird disponibles. Descuentos grupales (15+ personas): 10–20%.</p>
                  </template>

                  <!-- Slide 2: Sedes del Festival -->
                  <template v-if="infoSlide === 2">
                    <div class="carousel-card-header">
                      ...
                      <h3>Sedes del Festival</h3>
                    </div>
                    <p class="carousel-desc">Las proyecciones se realizan en múltiples espacios del centro de Austin. Transporte disponible para acreditados.</p>
                    <div class="venue-list">
                      <div class="venue-item"><strong>Paramount Theatre</strong><span>Austin, TX</span></div>
                      <div class="venue-item"><strong>ZACH Theatre</strong><span>Austin, TX</span></div>
                      <div class="venue-item"><strong>Rollins Theatre</strong><span>The Long Center</span></div>
                      <div class="venue-item"><strong>Alamo Lamar</strong><span>Austin, TX</span></div>
                      <div class="venue-item"><strong>Violet Crown Cinema</strong><span>Austin, TX</span></div>
                      <div class="venue-item"><strong>AFS Cinema</strong><span>Austin, TX</span></div>
                      <div class="venue-item"><strong>Fairmont Hotel</strong><span>Austin, TX</span></div>
                    </div>
                  </template>
                </div>
              </transition>
