    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.locarnofestival.ch" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/locarno/locarno_backdrop_2026_es.webp"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://www.locarnofestival.ch" target="_blank" class="accent-link">locarnofestival.ch</a></p>
                    <p class="carousel-desc">Uno de los festivales competitivos más antiguos del mundo, en marcha desde 1946 y articulado en torno a la Piazza Grande, una pantalla al aire libre para 8.000 espectadores. El Pardo d'Oro se entrega en el Concorso Internazionale, mientras que Cineasti del Presente y Pardi di Domani figuran entre las plataformas de descubrimiento más seguidas para óperas primas, segundas películas y cortometraje.</p>
                    <p class="carousel-desc"><strong>Redes:</strong> @locarnofilmfestival (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Entrada individual — salas</span><span class="price-value">CHF 15</span></li>
                      <li><span class="price-label">Entrada individual — Piazza Grande</span><span class="price-value">CHF 25</span></li>
                      <li><span class="price-label">Funciones matinales</span><span class="price-value">CHF 10</span></li>
                      <li><span class="price-label">Acreditación — festival completo</span><span class="price-value">CHF 220</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Taquilla:</strong> PalaCinema, Largo Zorzi y el quiosco de la Piazza Grande, además de la venta en línea desde el sitio oficial.</p>
                    <p class="carousel-desc"><strong>Piazza Grande:</strong> las funciones comienzan al anochecer, cerca de las 21:30. En caso de lluvia el programa se traslada a Palexpo (FEVI) con la misma entrada.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Piazza Grande</strong><span>Al aire libre, 8.000 localidades</span></div>
                      <div class="venue-item"><strong>PalaCinema 1 · 2 · 3</strong><span>Via Franchino Rusca 1, Locarno</span></div>
                      <div class="venue-item"><strong>GranRex</strong><span>Via Antonio Ciseri 6, Locarno</span></div>
                      <div class="venue-item"><strong>La Sala · L’altra Sala</strong><span>Via della Posta 4, Locarno</span></div>
                      <div class="venue-item"><strong>Palexpo (FEVI)</strong><span>Via Respini 11, Locarno</span></div>
                      <div class="venue-item"><strong>Teatro Kursaal</strong><span>Via Rusca 1, Locarno</span></div>
                      <div class="venue-item"><strong>PalaVideo</strong><span>Palazzo dei Congressi, Muralto</span></div>
                      <div class="venue-item"><strong>Cinema Rialto 1</strong><span>Via Stazione 3, Locarno</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
const CATEGORY_ORDER = [
    ...
    "Histoire(s) du Cinéma – Pardo d'Onore Manor Darren Aronofsky",
    "Histoire(s) du Cinéma – Pardo alla Carriera Ascona-Locarno Tourism James Gray",
    "Histoire(s) du Cinéma – Vision Award Ticinomoda Rick Baker",
    "Histoire(s) du Cinéma – Leopard Club Award Virginie Efira",
    "Histoire(s) du Cinéma – Life Achievement Award Asia Argento",
    "Histoire(s) du Cinéma – Homage to Isao Takahata",
    "Histoire(s) du Cinéma – Homage to Roger Corman",
    "Histoire(s) du Cinéma – Homage to Hannes Schmidhauser",
    "Histoire(s) du Cinéma – Cinéma Suisse Redécouvert",
    "Histoire(s) du Cinéma – Locarno Heritage",
    "Factory Screenings",
];

const CATEGORY_LABELS = {
    "Piazza Grande": "Piazza Grande",
    "Piazza Grande – Prefestival": "Piazza Grande – Prefestival",
    "Concorso Internazionale": "Concorso Internazionale",
    "Concorso Cineasti del Presente": "Concorso Cineasti del Presente",
    "Pardi di Domani – Concorso Internazionale": "Pardi di Domani – Concorso Internazionale",
    "Pardi di Domani – Concorso Nazionale": "Pardi di Domani – Concorso Nazionale",
    "Pardi di Domani – Concorso Corti d’Autore": "Pardi di Domani – Concorso Corti d’Autore",
    "Fuori Concorso": "Fuori Concorso",
    "Semaine de la Critique": "Semaine de la Critique",
    "Panorama Suisse": "Panorama Suisse",
    "Open Doors Screenings": "Open Doors Screenings",
    "Locarno Kids Screenings": "Locarno Kids Screenings",
    "Retrospettiva": "Retrospettiva",
    "Histoire(s) du Cinéma": "Histoire(s) du Cinéma",
    "Histoire(s) du Cinéma – Pardo d'Onore Manor Darren Aronofsky": "Histoire(s) du Cinéma – Pardo d'Onore Manor Darren Aronofsky",
    "Histoire(s) du Cinéma – Pardo alla Carriera Ascona-Locarno Tourism James Gray": "Histoire(s) du Cinéma – Pardo alla Carriera Ascona-Locarno Tourism James Gray",
    "Histoire(s) du Cinéma – Vision Award Ticinomoda Rick Baker": "Histoire(s) du Cinéma – Vision Award Ticinomoda Rick Baker",
    "Histoire(s) du Cinéma – Leopard Club Award Virginie Efira": "Histoire(s) du Cinéma – Leopard Club Award Virginie Efira",
    "Histoire(s) du Cinéma – Life Achievement Award Asia Argento": "Histoire(s) du Cinéma – Life Achievement Award Asia Argento",
    "Histoire(s) du Cinéma – Homage to Isao Takahata": "Histoire(s) du Cinéma – Homage to Isao Takahata",
    "Histoire(s) du Cinéma – Homage to Roger Corman": "Histoire(s) du Cinéma – Homage to Roger Corman",
    "Histoire(s) du Cinéma – Homage to Hannes Schmidhauser": "Histoire(s) du Cinéma – Homage to Hannes Schmidhauser",
    "Histoire(s) du Cinéma – Cinéma Suisse Redécouvert": "Histoire(s) du Cinéma – Cinéma Suisse Redécouvert",
    "Histoire(s) du Cinéma – Locarno Heritage": "Histoire(s) du Cinéma – Locarno Heritage",
    "Factory Screenings": "Factory Screenings",
    OTHER: "Otras",
};
