              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Edition:</strong> 79th Locarno Film Festival</p>
                    <p class="carousel-desc"><strong>Dates:</strong> August 5 – 15, 2026</p>
                    <p class="carousel-desc"><strong>Location:</strong> Locarno, Switzerland</p>
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://www.locarnofestival.ch" target="_blank" class="accent-link">locarnofestival.ch</a></p>
                    <p class="carousel-desc">One of the world's oldest competitive festivals, running since 1946 and built around the Piazza Grande — an open-air screen for 8,000 spectators. Its Pardo d'Oro is awarded in the Concorso Internazionale, while Cineasti del Presente and Pardi di Domani are among the most closely watched discovery platforms for first and second features and for short film.</p>
                    <p class="carousel-desc"><strong>Social:</strong> @locarnofilmfestival (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Single ticket — halls</span><span class="price-value">CHF 15</span></li>
                      <li><span class="price-label">Single ticket — Piazza Grande</span><span class="price-value">CHF 25</span></li>
                      <li><span class="price-label">Morning screenings</span><span class="price-value">CHF 10</span></li>
                      <li><span class="price-label">Accreditation — full festival</span><span class="price-value">CHF 220</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Box office:</strong> PalaCinema, Largo Zorzi and the Piazza Grande kiosk, plus online sales through the official site.</p>
                    <p class="carousel-desc"><strong>Piazza Grande:</strong> screenings begin at nightfall, around 21:30. In case of rain the programme moves to Palexpo (FEVI) with the same ticket.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Piazza Grande</strong><span>Open-air, 8,000 seats</span></div>
