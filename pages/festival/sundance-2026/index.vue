              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Sitio web:</strong> festival.sundance.org</p>
                    <p class="carousel-desc"><strong>Presencial:</strong> 22 de enero al 1 de febrero de 2026</p>
                    <p class="carousel-desc"><strong>Online:</strong> 29 de enero al 1 de febrero de 2026</p>
                    <ul class="price-list">
                      <li><span class="price-label">Pase de Cortometrajes</span><span class="price-value">$45</span></li>
                      <li><span class="price-label">Entradas individuales (online)</span><span class="price-value">$35</span></li>
                    </ul>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <p class="carousel-desc">Todos los pases y paquetes presenciales están <strong>agotados</strong>.</p>
                    <ul class="price-list">
                      <li><span class="price-label">Entradas individuales (presencial)</span><span class="price-value">$35</span></li>
                    </ul>
                    <p class="carousel-desc">Sistema de lista de espera disponible en la app oficial del festival. Los asientos no utilizados se liberan para quienes estén en la lista.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>The Eccles Theater</strong><span>1750 Kearns Blvd., Park City</span></div>
                      <div class="venue-item"><strong>Library Center Theatre</strong><span>1255 Park Ave., Park City</span></div>
                      <div class="venue-item"><strong>The Ray Theatre</strong><span>1768 Park Ave., Park City</span></div>
                      <div class="venue-item"><strong>The Yarrow</strong><span>1800 Park Ave., DoubleTree Hotel</span></div>
                      <div class="venue-item"><strong>Megaplex at Redstone</strong><span>6030 Market St., Kimball Junction</span></div>
                      <div class="venue-item"><strong>Rose Wagner Center</strong><span>138 W. 300 South, Salt Lake City</span></div>
                      <div class="venue-item"><strong>Broadway Centre Cinemas</strong><span>111 E. 300 South, Salt Lake City</span></div>
                      <div class="venue-item"><strong>Holiday Village Cinemas</strong><span>1776 Park Ave. (29 ene – 1 feb)</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
onMounted(async () => {
    try {
        const [filmsData, scheduleData, awardsData] = await Promise.all([
            ...
            $fetch('/api/festival/sundance/schedule').catch(() => ({ results: [] })),
