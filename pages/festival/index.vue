      ...
      <div class="festivals-grid">
        <nuxt-link to="/festival/tribeca-2026" class="festival-card">
          <div class="card-image-wrapper">
             <img src="/festivals/tribeca/tribeca_backdrop_2026_eng.webp" alt="Tribeca Festival 2026" />
             <div class="overlay"></div>
             <div class="card-content">
               <h2>Tribeca 2026</h2>
               <span class="festival-dates">Jun 3–14, 2026</span>
        ...
        <nuxt-link to="/festival/bafici-2026" class="festival-card">
          <div class="card-image-wrapper">
             ...
             <div class="card-content">
               <h2>BAFICI 2026</h2>
               <span class="festival-dates">Apr 15-26, 2026</span>
               <span class="explore-btn">Explore</span>
             </div>
          </div>
        </nuxt-link>
        ...
        <nuxt-link to="/festival/berlinale-2026" class="festival-card">
          <div class="card-image-wrapper">
             <img src="/festivals/berlinale/berlinale_backdrop_2026_eng.webp" alt="Berlinale 2026" />
             <div class="overlay"></div>
             <div class="card-content">
        ...
        <nuxt-link to="/festival/rotterdam-2026" class="festival-card">
          <div class="card-image-wrapper">
             <img src="/festivals/rotterdam/rotterdam_backdrop_2026_eng.webp" alt="Rotterdam 2026" />
             <div class="overlay"></div>
             <div class="card-content">
