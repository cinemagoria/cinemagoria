    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://tribecafilm.com" target="_blank" class="hero-backdrop">
            <img
              src="/festivals/tribeca/tribeca_backdrop_2026_eng.webp"
              alt="Tribeca Backdrop"
            />
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://tribecafilm.com" target="_blank" class="accent-link">tribecafilm.com</a></p>
                    <p class="carousel-desc"><strong>Dates:</strong> June 3 – 14, 2026</p>
                    <p class="carousel-desc"><strong>Location:</strong> New York City — multiple venues across Manhattan and Brooklyn.</p>
                    <p class="carousel-desc">Founded in 2002 by Robert De Niro, Jane Rosenthal and Craig Hatkoff, Tribeca is one of the world's leading festivals for film, TV, audio, games, immersive, and music.</p>
                    <p class="carousel-desc"><strong>Social:</strong> @tribeca (Instagram / X)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Individual Ticket</span><span class="price-value">$28</span></li>
                      <li><span class="price-label">Tribeca At Home (online)</span><span class="price-value">$12</span></li>
                      <li><span class="price-label">Tribeca Member Ticket</span><span class="price-value">$22</span></li>
                      <li><span class="price-label">Festival Pass (various tiers)</span><span class="price-value">From $225</span></li>
                    </ul>
                    <p class="carousel-desc">Tickets available at <a href="https://tribecafilm.com/festival" target="_blank" class="accent-link">tribecafilm.com/festival</a>. Members and industry guests get early access windows.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Beacon Theatre</strong><span>2124 Broadway, Manhattan</span></div>
                      <div class="venue-item"><strong>SVA Theatre</strong><span>333 W 23rd St, Manhattan</span></div>
                      <div class="venue-item"><strong>Village East by Angelika</strong><span>181-189 2nd Ave, Manhattan</span></div>
                      <div class="venue-item"><strong>AMC 19th Street East 6</strong><span>890 Broadway, Manhattan</span></div>
                      <div class="venue-item"><strong>BMCC Tribeca PAC</strong><span>199 Chambers St, Manhattan</span></div>
                      <div class="venue-item"><strong>OKX Theater at Spring Studios</strong><span>50 Varick St, Manhattan</span></div>
                      <div class="venue-item"><strong>Indie Brooklyn at Brooklyn Navy Yard</strong><span>Building 77, Brooklyn</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
const CATEGORY_LABELS = {
    'Galas': 'Galas',
    'U.S. Narrative Competition': 'U.S. Narrative Competition',
    'International Narrative Competition': 'International Narrative Competition',
    'Documentary Competition': 'Documentary Competition',
    'Spotlight Narrative': 'Spotlight Narrative',
    'Spotlight Documentary': 'Spotlight Documentary',
    'Spotlight+': 'Spotlight+',
    'Viewpoints': 'Viewpoints',
    'Escape From Tribeca': 'Escape From Tribeca',
    'Narrative Short': 'Narrative Shorts',
    'Documentary Short': 'Documentary Shorts',
    'Animated Short': 'Animated Shorts',
    'Music Video Short': 'Music Video Shorts',
    OTHER: 'Other',
};
...
const filmsByCategory = computed(() => {
    ...
    for (const f of films.value?.results || []) {
        let key = String(f.category || f.section || '').trim();
        // Unify all Galas subcategories into one group
        if (key.startsWith('Galas')) key = 'Galas';
...
// Uses :deep() because TribecaCard is a child component (scoped CSS).
