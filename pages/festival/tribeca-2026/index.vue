              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://tribecafilm.com" target="_blank" class="accent-link">tribecafilm.com</a></p>
                    <p class="carousel-desc"><strong>Fechas:</strong> 3 – 14 de junio de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Nueva York — múltiples sedes en Manhattan y Brooklyn.</p>
                    <p class="carousel-desc">Fundado en 2002 por Robert De Niro, Jane Rosenthal y Craig Hatkoff, Tribeca es uno de los festivales líderes en cine, TV, audio, juegos, experiencias inmersivas y música.</p>
                    <p class="carousel-desc"><strong>Redes:</strong> @tribeca (Instagram / X)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Entrada individual</span><span class="price-value">$28</span></li>
                      <li><span class="price-label">Tribeca At Home (online)</span><span class="price-value">$12</span></li>
                      <li><span class="price-label">Entrada Miembro Tribeca</span><span class="price-value">$22</span></li>
                      <li><span class="price-label">Pase del Festival (varios niveles)</span><span class="price-value">Desde $225</span></li>
                    </ul>
                    <p class="carousel-desc">Entradas disponibles en <a href="https://tribecafilm.com/festival" target="_blank" class="accent-link">tribecafilm.com/festival</a>. Miembros e industria acceden con ventanas anticipadas.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      ...
                      <div class="venue-item"><strong>Indie Brooklyn at Brooklyn Navy Yard</strong><span>Edificio 77, Brooklyn</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
const CATEGORY_LABELS = {
    'Galas': 'Galas',
    'U.S. Narrative Competition': 'Competencia Narrativa EE.UU.',
    'International Narrative Competition': 'Competencia Narrativa Internacional',
    'Documentary Competition': 'Competencia Documental',
    'Spotlight Narrative': 'Spotlight Narrativo',
    'Spotlight Documentary': 'Spotlight Documental',
    'Spotlight+': 'Spotlight+',
    'Viewpoints': 'Viewpoints',
    'Escape From Tribeca': 'Escape From Tribeca',
    'Narrative Short': 'Cortometrajes Narrativos',
    'Documentary Short': 'Cortometrajes Documentales',
    'Animated Short': 'Cortometrajes Animados',
    'Music Video Short': 'Cortometrajes Videoclip',
    OTHER: 'Otros',
};
