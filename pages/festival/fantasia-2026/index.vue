    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://fantasiafestival.com" target="_blank" rel="noopener noreferrer" class="hero-backdrop">
            <img
              src="/festivals/fantasia/fantasia_backdrop_2026_es.webp"
              alt="Festival Internacional Fantasia 2026 Backdrop"
            />
          ...
          <div v-if="schedule.length > 0" class="schedule-toolbar" :class="{ 'search-active': isScheduleSearchActive }">
            ...
            <div class="search-wrapper" :class="{ 'active': isScheduleSearchActive }">
              ...
              <div class="search-input-container" :class="{ 'show': isScheduleSearchActive }">
                ...
                >
                <button class="clear-search-btn" @click="clearScheduleSearch" v-if="scheduleSearch" aria-label="Borrar búsqueda">
                  ...
                  <div v-for="screening in dayScreenings" :key="screening.id" class="screening-card">
                     <div class="time-block">
                      ...
                      <div class="poster-mini">
                          ...
                          />
                          <img v-else src="/placeholders/image_not_found_yet.webp" alt="Sin póster" />
                      </div>
                  </div>
                </div>
            </transition>
                ...
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <div class="youtube-embed">
                      <iframe src="https://www.youtube.com/embed/rg4jTk2EtDI" title="Festival Internacional Fantasia 2026" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <p class="carousel-desc"><strong>Fechas:</strong> 16 de julio – 2 de agosto de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Montreal, Quebec, Canadá</p>
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://fantasiafestival.com" target="_blank" rel="noopener noreferrer" class="accent-link">fantasiafestival.com</a></p>
                    <p class="carousel-desc"><strong>Fantasia</strong> es una de las plataformas más influyentes del cine de género en el mundo: terror, ciencia ficción, fantasía, acción, animación y cine de culto. Reconocido por su público electrizante y por revelar talento emergente, el festival ancla el verano montrealense con estrenos internacionales y una programación que empuja los límites del formato.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Entradas individuales</span><span class="price-value">En boletería y online</span></li>
                      <li><span class="price-label">Festival passes</span><span class="price-value">Abonos multi-día</span></li>
                      <li><span class="price-label">Acreditación industria y prensa</span><span class="price-value">Mediante solicitud</span></li>
                    </ul>
                    <p class="carousel-desc">Los precios, tipos de pase y fechas de venta son publicados por el festival cerca de la apertura. Las entradas se ponen a disposición a través de la boletería oficial de Fantasia y sedes asociadas en Montreal.</p>
                    <p class="carousel-desc"><strong>Atmósfera marcada por el público:</strong> las funciones de Fantasia son famosas por ser interactivas — salas llenas, reacciones ruidosas y Q&amp;As con directores.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      ...
                      <div class="venue-item"><strong>Sedes asociadas adicionales</strong><span>Anunciadas junto con la programación</span></div>
                    </div>
                  </template>
                </div>
              </transition>
