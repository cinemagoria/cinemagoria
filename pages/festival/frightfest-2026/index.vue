    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://frightfest.co.uk/tickets/" target="_blank" rel="noopener noreferrer" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/frightfest/frightfest_backdrop_2026_es.webp"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Fechas:</strong> 27 – 31 de agosto de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Londres, Reino Unido</p>
