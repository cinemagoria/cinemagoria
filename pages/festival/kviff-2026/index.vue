    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.kviff.com" target="_blank" class="hero-backdrop">
            <img
              src="/festivals/kviff/kviff_backdrop_2026_es.webp"
              alt="Festival Internacional de Cine de Karlovy Vary 2026 Backdrop"
            />
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Edición:</strong> 60ª edición del Festival Internacional de Cine de Karlovy Vary</p>
                    <p class="carousel-desc"><strong>Fechas:</strong> 3 – 11 de julio de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Karlovy Vary, República Checa</p>
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://www.kviff.com" target="_blank" class="accent-link">kviff.com</a></p>
                    <p class="carousel-desc">El mayor festival de cine de la República Checa y uno de los más antiguos de Europa, KVIFF presenta cerca de 200 películas entre secciones competitivas y no competitivas, con sólidos programas de industria, KVIFF Talks y un dinámico ecosistema de Festival Pass para audiencias internacionales.</p>
                    <p class="carousel-desc"><strong>Redes:</strong> @kviff (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Hotel Thermal — Velký sál (Sala Mayor)</strong><span>Sede central del festival, Karlovy Vary</span></div>
                      <div class="venue-item"><strong>Hotel Thermal — Malý sál (Sala Menor)</strong><span>Karlovy Vary</span></div>
