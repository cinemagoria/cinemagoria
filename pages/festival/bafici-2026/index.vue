      ...
      <div v-else>
        ...
        <div v-if="activeTab === 'schedule'" class="schedule-container">
          <div class="schedule-empty-state">
            ...
            <h2 class="schedule-empty-title">Schedule To Be Announced</h2>
            <p class="schedule-empty-desc">The official screening schedule for BAFICI 27 will be available once published by the festival.</p>
          </div>
        </div>
      </div>
    </div>
