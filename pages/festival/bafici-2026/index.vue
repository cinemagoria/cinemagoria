                ...
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <ul class="price-list">
                      ...
                      <li><span class="price-label">BAFICI Pass (10 tickets)</span><span class="price-value">$30,000</span></li>
                    </ul>
                    <div class="promo-box">
                      <span class="promo-tag">PROMO</span>
                      <p><strong>Banco Ciudad:</strong> 2×1 with debit or credit card (subject to availability).</p>
                    </div>
                  </template>

                  <!-- Slide 1: Free Activities -->
                  <template v-if="infoSlide === 1">
                    <div class="carousel-card-header">
                      ...
                      <h3>Free Activities &amp; Screenings</h3>
                    </div>
                    <div class="activity-type">
                      <span class="badge gr">GR</span>
                      <p><strong>With Reservation:</strong> Tickets can be requested from 48 hours before, starting at 10 AM via bafici.org, and at Teatro San Martín and other festival box offices during opening hours.</p>
                    </div>
                    <div class="activity-type">
                      <span class="badge gs">GS</span>
                      <p><strong>No Reservation:</strong> Entry to free activities and screenings without reservation is on a first-come, first-served basis subject to venue capacity. No accreditation is required to enter.</p>
                    </div>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    <div class="carousel-card-header">
                      ...
                      <h3>Official Venues — 27° BAFICI</h3>
                    </div>
                    <div class="venue-list">
                      <div class="venue-item"><strong>Teatro San Martín</strong><span>Sala Lugones, Hall Alcón, Casacuberta &amp; Coronado — Av. Corrientes 1530</span></div>
                      ...
                      <div class="venue-item"><strong>Cinépolis Plaza Houssay</strong><span>Rooms 1–4 — Av. Córdoba 2135</span></div>
                      <div class="venue-item"><strong>Cinépolis Recoleta</strong><span>Rooms 2–3 — Vicente López 2050</span></div>
                      <div class="venue-item"><strong>CineArte Cacodelphia</strong><span>Rooms 1–3 — Av. Pres. Roque Sáenz Peña 1150</span></div>
