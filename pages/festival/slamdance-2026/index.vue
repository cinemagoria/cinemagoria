              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://slamdance.com" target="_blank" class="accent-link">slamdance.com</a></p>
                    <p class="carousel-desc"><strong>Dates:</strong> February 19 – 26, 2026</p>
                    <p class="carousel-desc">Access to the full virtual festival is available from the convenience of home. Many screenings offer <strong>captioning</strong> and <strong>audio descriptions</strong>.</p>
                    <p class="carousel-desc"><strong>Social:</strong> @sabordeslamdance (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Digital Pass (all online screenings)</span><span class="price-value">$5</span></li>
                      <li><span class="price-label">Individual Digital Ticket</span><span class="price-value">$2.50</span></li>
                      <li><span class="price-label">Box Office Hours</span><span class="price-value">11:00 AM – 9:00 PM</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Box Office Location:</strong> Treasure Mountain Inn, Park City, UT 84060</p>
                    <p class="carousel-desc"><strong>Festival Office:</strong> 5634 Kearns Blvd, Park City, UT 84098</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Treasure Mountain Inn</strong><span>255 Main St., Park City, UT 84060</span></div>
                      <div class="venue-item"><strong>SL Screening Room 1 &amp; 2</strong><span>Treasure Mountain Inn</span></div>
                      <div class="venue-item"><strong>SL Screening Room 3 &amp; 4</strong><span>Treasure Mountain Inn</span></div>
                      <div class="venue-item"><strong>Slamdance Cinema</strong><span>Treasure Mountain Inn, Park City</span></div>
                    </div>
                  </template>
                </div>
              </transition>
