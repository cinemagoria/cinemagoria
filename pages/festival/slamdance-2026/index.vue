    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://slamdance.com" target="_blank" class="hero-backdrop">
            <img 
              ref="backdropImgRef"
              src="/festivals/slamdance/slamdance_backdrop_2026_es.webp" 
              alt="Fondo Slamdance"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://slamdance.com" target="_blank" class="accent-link">slamdance.com</a></p>
                    <p class="carousel-desc"><strong>Instagram:</strong> @slamdancegroup &nbsp;|&nbsp; <strong>X:</strong> @slamdance</p>
                    <p class="carousel-desc"><strong>Email:</strong> support@slamdance.com &nbsp;|&nbsp; <strong>Hashtag:</strong> #slamdance2026</p>
                    <div class="promo-box">
                      <span class="promo-tag">VIRTUAL</span>
                      <p>Plataforma <strong>Slamdance Channel</strong> — Disponible del 24 de febrero al 6 de marzo. Apple TV, Firestick, Roku y Web. Acceso anual: <strong>$50</strong> / Pase virtual: <strong>$7.99</strong>.</p>
                    </div>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Pase All Access</span><span class="price-value">$50</span></li>
                      <li><span class="price-label">Entradas individuales</span><span class="price-value">$19</span></li>
                      <li><span class="price-label">Eventos</span><span class="price-value">Gratis</span></li>
                    </ul>
                    <p class="carousel-desc">Compra en slamdance.com o boletería física. Acceso virtual: slamdancechannel.com.</p>
                    <p class="carousel-desc" style="margin-top: 0.5rem;"><strong>Horarios de boletería:</strong></p>
                    <ul class="bullet-list">
                      <li>19 feb: 13:00–21:00</li>
                      <li>20 feb: 09:00–22:00</li>
                      <li>21–22 feb: 09:00–22:15</li>
                      <li>23 feb: 09:00–20:30</li>
                      <li>24–25 feb: 11:00–22:30 / 21:30</li>
                    </ul>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Directors Guild of America</strong><span>7920 W Sunset Blvd, Los Ángeles</span></div>
                      <div class="venue-item"><strong>Landmark Sunset</strong><span>8000 W Sunset Blvd, West Hollywood</span></div>
                      <div class="venue-item"><strong>2220 Arts + Archive</strong><span>2220 Beverly Blvd, Los Ángeles</span></div>
                      <div class="venue-item"><strong>Egyptian Theatre</strong><span>6712 Hollywood Blvd, Los Ángeles</span></div>
                    </div>
                    <div class="promo-box" style="margin-top: 1.2rem;">
                      <span class="promo-tag">OFICINA</span>
                      <p><strong>Oficina del Festival:</strong> 19 feb 13:00–18:00 / 20–25 feb 10:00–12:00 y 13:00–18:00.</p>
                    </div>
                  </template>
                </div>
              </transition>
...
onMounted(async () => {
    try {
        const [filmsData, scheduleData, awardsData] = await Promise.all([
            ...
            $fetch('/api/festival/slamdance/schedule').catch(() => ({ results: [] })),
            $fetch('/api/festival/slamdance/awards').catch(() => ({ results: [] })),
        ]);
