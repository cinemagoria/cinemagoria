  ...
  <main class="main">
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.bifan.kr" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/bifan/bifan_backdrop_2026_es.webp"
              alt="BIFAN 2026 Backdrop"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Edición:</strong> 30.ª edición del Bucheon International Fantastic Film Festival</p>
                    <p class="carousel-desc"><strong>Fechas:</strong> 2 – 12 de julio de 2026</p>
                    <p class="carousel-desc"><strong>Ubicación:</strong> Bucheon, Corea del Sur</p>
                    <p class="carousel-desc"><strong>Sitio web:</strong> <a href="https://www.bifan.kr" target="_blank" class="accent-link">bifan.kr</a></p>
                    <p class="carousel-desc">El principal festival de género de Asia, celebrado en Bucheon desde 1997 y dedicado al fantástico, el terror, la ciencia ficción y el thriller. Sus secciones competitivas son Bucheon Choice para largometrajes y cortometrajes, divididas entre selección coreana e internacional, junto a una competencia Bucheon Choice AI Films que lo convierte en uno de los primeros grandes festivales en dar al cine asistido por IA su propia sección con jurado.</p>
                    <p class="carousel-desc"><strong>Redes:</strong> @bifan_official (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Entrada individual</span><span class="price-value">KRW 8,000</span></li>
                      <li><span class="price-label">Función de apertura / clausura</span><span class="price-value">KRW 20,000</span></li>
                      <li><span class="price-label">Funciones al aire libre</span><span class="price-value">Gratis</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Taquilla:</strong> mostradores en el Bucheon City Hall y en los multicines participantes, además de la reserva en línea desde el sitio oficial.</p>
                    <p class="carousel-desc">Las funciones del <strong>Neighborhood Cinema Tour</strong> se realizan en bibliotecas, escuelas y plazas públicas de Bucheon y son de acceso libre.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Bucheon City Hall</strong><span>Sala principal · Fantastic Cube — sede del festival</span></div>
                      <div class="venue-item"><strong>CGV Sopung</strong><span>Salas 4 – 10, Bucheon</span></div>
                      <div class="venue-item"><strong>LOTTE Cinema Bucheon</strong><span>Salas 1 – 3</span></div>
                      <div class="venue-item"><strong>MEGABOX Starfield City</strong><span>Salas 1 – 3, Bucheon</span></div>
                      <div class="venue-item"><strong>Korea Manhwa Museum</strong><span>Bucheon</span></div>
                      <div class="venue-item"><strong>Ojeong Art Hall · Solan Art Hall</strong><span>Bucheon</span></div>
                      <div class="venue-item"><strong>Bucheon City Hall Lawn Square</strong><span>Funciones al aire libre</span></div>
                    </div>
                  </template>
                </div>
              </transition>
...
const CATEGORY_ORDER = [
    ...
    "Bucheon Choice Korean",
    "Bucheon Choice AI Films",
    "Fantastic Shorts",
    "Asian Genre Films 99",
    "B Extreme",
    "Strange Hommage",
    "Fanta-scape",
    "Signature",
    "AI Frontier",
    "Neighborhood Cinema Tour",
];

const CATEGORY_LABELS = {
    "Opening Film": "Opening Film",
    "Bucheon Choice World": "Bucheon Choice World",
    "Bucheon Choice Korean": "Bucheon Choice Korean",
    "Bucheon Choice AI Films": "Bucheon Choice AI Films",
    "Fantastic Shorts": "Fantastic Shorts",
    "Asian Genre Films 99": "Asian Genre Films 99",
    "B Extreme": "B Extreme",
    "Strange Hommage": "Strange Hommage",
    "Fanta-scape": "Fanta-scape",
    "Signature": "Signature",
    "AI Frontier": "AI Frontier",
    "Neighborhood Cinema Tour": "Neighborhood Cinema Tour",
    OTHER: "Otras",
};
...
onMounted(async () => {
    try {
        const [filmsData, scheduleData, awardsData] = await Promise.all([
            $fetch('/api/festival/bifan/films?limit=400&sort=title'),
            $fetch('/api/festival/bifan/schedule').catch(() => ({ results: [] })),
            $fetch('/api/festival/bifan/awards').catch(() => ({ results: [] })),
        ]);
