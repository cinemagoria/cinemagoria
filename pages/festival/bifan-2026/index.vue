    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.bifan.kr" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/bifan/bifan_backdrop_2026_en.webp"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Edition:</strong> 30th Bucheon International Fantastic Film Festival</p>
                    <p class="carousel-desc"><strong>Dates:</strong> July 2 – 12, 2026</p>
                    <p class="carousel-desc"><strong>Location:</strong> Bucheon, South Korea</p>
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://www.bifan.kr" target="_blank" class="accent-link">bifan.kr</a></p>
                    <p class="carousel-desc">Asia's leading genre festival, held in Bucheon since 1997 and dedicated to fantasy, horror, science fiction and thriller. Its competitive strands are Bucheon Choice for features and shorts, split between Korean and international selections, alongside a Bucheon Choice AI Films competition that makes it one of the first major festivals to give AI-assisted filmmaking its own juried section.</p>
                    <p class="carousel-desc"><strong>Social:</strong> @bifan_official (Instagram)</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Single ticket</span><span class="price-value">KRW 8,000</span></li>
                      <li><span class="price-label">Opening / closing film</span><span class="price-value">KRW 20,000</span></li>
                      <li><span class="price-label">Outdoor screenings</span><span class="price-value">Free</span></li>
                    </ul>
                    <p class="carousel-desc"><strong>Box office:</strong> on-site desks at Bucheon City Hall and the participating multiplexes, plus online booking through the official site.</p>
                    <p class="carousel-desc"><strong>Neighborhood Cinema Tour</strong> screenings are staged in libraries, schools and public squares across Bucheon and are free to attend.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Bucheon City Hall</strong><span>Main Theater · Fantastic Cube — Festival HQ</span></div>
                      <div class="venue-item"><strong>CGV Sopung</strong><span>Screens 4 – 10, Bucheon</span></div>
                      <div class="venue-item"><strong>LOTTE Cinema Bucheon</strong><span>Screens 1 – 3</span></div>
                      <div class="venue-item"><strong>MEGABOX Starfield City</strong><span>Screens 1 – 3, Bucheon</span></div>
                      ...
                      <div class="venue-item"><strong>Bucheon City Hall Lawn Square</strong><span>Open-air screenings</span></div>
                    </div>
                  </template>
                </div>
              </transition>
