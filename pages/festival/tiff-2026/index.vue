    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://tiff.net/ticket-pricing" target="_blank" rel="noopener noreferrer" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/tiff/tiff_backdrop_2026_en.webp"
              alt="TIFF 2026 Backdrop"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://tiff.net" target="_blank" rel="noopener noreferrer" class="accent-link">tiff.net</a></p>
                    <p class="carousel-desc"><strong>Dates:</strong> September 10 – 20, 2026, in Toronto, Ontario, Canada.</p>
                    <p class="carousel-desc">The <strong>Toronto International Film Festival</strong> is the largest publicly attended film festival in the world and one of the most important launchpads for the awards season. The <strong>51st edition</strong>, presented by Rogers, opens with the world premiere of Siân Heder's <em>Being Heumann</em> at Roy Thomson Hall.</p>
                    <p class="carousel-desc">This year also marks the inaugural <strong>TIFF: The Market</strong>, running September 10–16 at the Metro Toronto Convention Centre.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Individual Tickets</span><span class="price-value">$25–60</span></li>
                      <li><span class="price-label">Curated Packages</span><span class="price-value">$200–800</span></li>
                      <li><span class="price-label">Festival Passes</span><span class="price-value">$400–1,500+</span></li>
                    </ul>
                    <p class="carousel-desc">Single tickets go on sale to TIFF Members starting August 21 (by membership level), and to the public on August 31, 2026, via Ticketmaster.</p>
