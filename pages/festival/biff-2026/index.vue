    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.biff.kr" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/biff/biff_backdrop_2026_en.webp"
              alt="Busan International Film Festival 2026 Backdrop"
...
<!-- Slide 0: General Information -->
                  <template v-if="infoSlide === 0">
                    ...
                    <div class="youtube-embed">
                      <iframe src="https://www.youtube.com/embed/V2Pcaj580dI" title="Busan International Film Festival 2026" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <p class="carousel-desc"><strong>Edition:</strong> 31st Busan International Film Festival</p>
                    <p class="carousel-desc"><strong>Dates:</strong> October 6 – 15, 2026</p>
                    <p class="carousel-desc"><strong>Location:</strong> Busan, South Korea</p>
                    <p class="carousel-desc"><strong>Website:</strong> <a href="https://www.biff.kr" target="_blank" class="accent-link">biff.kr</a></p>
                    <p class="carousel-desc">Asia's largest film festival, running since 1996 and built around the Busan Cinema Center in the Haeundae district. Its programme spans a competitive section for Asian features, dedicated discovery platforms for independent cinema from Asia and Korea, and one of the circuit's broadest short-film and documentary showcases. This edition names Michelle Yeoh Asian Filmmaker of the Year and dedicates a retrospective to her career.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <p class="carousel-desc">The festival had not published its ticket prices for this edition when this page was built. Sales open through the official site and the on-site box offices, and this section is updated once the price list is released.</p>
                    <p class="carousel-desc"><strong>Official sales:</strong> <a href="https://www.biff.kr" target="_blank" class="accent-link">biff.kr</a>, plus the box offices at the festival venues.</p>
                    <p class="carousel-desc"><strong>Open Cinema:</strong> screenings take place outdoors at the Busan Cinema Center's Roof Theater and begin after nightfall.</p>
                    <p class="carousel-desc"><strong>Midnight Passion:</strong> three titles a night across three consecutive nights, Thursday to Saturday.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 3">
                    ...
                    <div class="section-glossary">
                      <div class="section-glossary-item"><strong>Opening Film</strong><span>The film that opens the festival.</span></div>
                      <div class="section-glossary-item"><strong>Gala Presentation</strong><span>Five globally acclaimed works, presented with their directors and casts in attendance.</span></div>
                      <div class="section-glossary-item"><strong>Icons</strong><span>Thirty-five films by contemporary masters of world cinema.</span></div>
                      <div class="section-glossary-item"><strong>Competition</strong><span>Fourteen Asian features exploring new possibilities of cinematic language.</span></div>
                      <div class="section-glossary-item"><strong>Vision — Asia · Korea</strong><span>Independent cinema from across Asia and from Korea, twelve titles in each strand.</span></div>
                      <div class="section-glossary-item"><strong>A Window on Asian Cinema</strong><span>Established Asian filmmakers alongside emerging talents.</span></div>
                      <div class="section-glossary-item"><strong>Korean Cinema Today</strong><span>Special Premiere brings recent mainstream Korean premieres; Panorama covers the breadth of Korean cinema.</span></div>
                      <div class="section-glossary-item"><strong>World Cinema</strong><span>Contemporary filmmaking beyond Asia, including award winners from other festivals.</span></div>
                      <div class="section-glossary-item"><strong>Flash Forward</strong><span>First and second features by emerging non-Asian directors, with an audience-voted award.</span></div>
                      <div class="section-glossary-item"><strong>Wide Angle</strong><span>Shorts and documentaries across four strands: Korean Shorts, Asian Shorts, Documentary Competition and Documentary Showcase.</span></div>
                      <div class="section-glossary-item"><strong>Open Cinema</strong><span>Acclaimed films with wide appeal, screened outdoors at the Cinema Center's Roof Theater.</span></div>
                      <div class="section-glossary-item"><strong>Midnight Passion</strong><span>Nine films, three a night, across three nights.</span></div>
                      <div class="section-glossary-item"><strong>On Screen</strong><span>The year's most anticipated drama series.</span></div>
                      <div class="section-glossary-item"><strong>In Focus</strong><span>Three retrospectives this edition: Ahn Sung-ki, Japanese animation, and Michelle Yeoh.</span></div>
...
const CATEGORY_LABELS = {
    ...
    ["A Window on Asian Cinema"]: "A Window on Asian Cinema",
    ["Korean Cinema Today — Special Premiere"]: "Korean Cinema Today — Special Premiere",
    ["Korean Cinema Today — Panorama"]: "Korean Cinema Today — Panorama",
    ["World Cinema"]: "World Cinema",
    ["Flash Forward"]: "Flash Forward",
    ["Wide Angle - Korean Short Film Competition"]: "Wide Angle — Korean Shorts",
    ["Wide Angle - Asian Short Film Competition"]: "Wide Angle — Asian Shorts",
    ["Wide Angle - Documentary Competition"]: "Wide Angle — Documentary Competition",
    ["Wide Angle - Documentary Showcase"]: "Wide Angle — Documentary Showcase",
    ["Open Cinema"]: "Open Cinema",
    ["Midnight Passion"]: "Midnight Passion",
    ["On Screen"]: "On Screen",
    ["Special Program in Focus - Those Beautiful Years, Ahn Sung-ki"]: "In Focus — Ahn Sung-ki",
    ["Special Program in Focus - Japanese Animation Special: Masterpieces of Madness, Exhilarating Prospects 12+1"]: "In Focus — Japanese Animation",
    ["Special Program in Focus - Everything Everywhere All for Michelle"]: "In Focus — Michelle Yeoh",
    ["Special Screenings & Carte Blanche"]: "Special Screenings & Carte Blanche",
    OTHER: "Other",
};
