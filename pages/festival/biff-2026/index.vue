  ...
  <main class="main">
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.biff.kr" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/biff/biff_backdrop_2026_es.webp"
              alt="Backdrop del Festival Internacional de Cine de Busan 2026"
...
<!-- Slide 0: General Information -->
                  <template v-if="infoSlide === 0">
                    ...
                    <div class="youtube-embed">
                      <iframe src="https://www.youtube.com/embed/V2Pcaj580dI" title="Festival Internacional de Cine de Busan 2026" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <p class="carousel-desc"><strong>Edición:</strong> 31.ª del Festival Internacional de Cine de Busan</p>
                    <p class="carousel-desc"><strong>Fechas:</strong> 6 – 15 de octubre de 2026</p>
                    <p class="carousel-desc"><strong>Sede:</strong> Busan, Corea del Sur</p>
                    <p class="carousel-desc"><strong>Sitio oficial:</strong> <a href="https://www.biff.kr" target="_blank" class="accent-link">biff.kr</a></p>
                    <p class="carousel-desc">El festival más grande de Asia, en marcha desde 1996 y organizado alrededor del Busan Cinema Center, en el barrio de Haeundae. Su programa reúne una sección competitiva de largometrajes asiáticos, plataformas dedicadas al cine independiente de Asia y de Corea, y una de las muestras de cortometraje y documental más amplias del circuito. Esta edición nombra a Michelle Yeoh cineasta asiática del año y le dedica una retrospectiva.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 1">
                    ...
                    <p class="carousel-desc">El festival todavía no había publicado los precios de esta edición cuando se armó esta página. La venta se abre a través del sitio oficial y de las boleterías en sede, y esta sección se actualiza en cuanto se difunda la lista de precios.</p>
                    <p class="carousel-desc"><strong>Venta oficial:</strong> <a href="https://www.biff.kr" target="_blank" class="accent-link">biff.kr</a>, además de las boleterías de cada sede.</p>
                    <p class="carousel-desc"><strong>Open Cinema:</strong> las funciones son al aire libre, en el Roof Theater del Busan Cinema Center, y empiezan al caer la noche.</p>
                    <p class="carousel-desc"><strong>Midnight Passion:</strong> tres títulos por noche durante tres noches seguidas, de jueves a sábado.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Busan Cinema Center</strong><span>Sede central: Cinema 1, Cinema 2, Cinematheque, Haneulyeon Theatre y el Roof Theater al aire libre</span></div>
                      <div class="venue-item"><strong>LOTTE CINEMA Centum City</strong><span>Nueve salas, el bloque más grande de la grilla</span></div>
                      <div class="venue-item"><strong>CGV Centum City</strong><span>Siete salas, incluida la pantalla IMAX</span></div>
                      <div class="venue-item"><strong>Sohyang Theatre Woori Bank Hall</strong><span>Auditorio que el festival usa para las funciones más grandes</span></div>
                      <div class="venue-item"><strong>Busan Community Media Center</strong><span>Open Hall</span></div>
                      <div class="venue-item"><strong>KOFIC Theater</strong><span>Sala del Consejo de Cine de Corea</span></div>
                    </div>
                    <p class="carousel-desc">Veinticuatro salas en seis sedes, todas dentro o alrededor de Centum City. La pestaña de horarios indica la sala de cada función.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 3">
                    ...
                    <div class="section-glossary">
                      <div class="section-glossary-item"><strong>Opening Film</strong><span>La película que abre el festival.</span></div>
                      <div class="section-glossary-item"><strong>Gala Presentation</strong><span>Cinco obras aclamadas internacionalmente, presentadas con la asistencia de sus directores y elencos.</span></div>
                      <div class="section-glossary-item"><strong>Icons</strong><span>Treinta y cinco películas de maestros contemporáneos del cine mundial.</span></div>
                      <div class="section-glossary-item"><strong>Competition</strong><span>Catorce largometrajes asiáticos que exploran nuevas posibilidades del lenguaje cinematográfico.</span></div>
                      <div class="section-glossary-item"><strong>Vision — Asia · Corea</strong><span>Cine independiente de Asia y de Corea, doce títulos en cada rama.</span></div>
                      <div class="section-glossary-item"><strong>A Window on Asian Cinema</strong><span>Cineastas asiáticos consagrados junto a nuevos talentos.</span></div>
                      <div class="section-glossary-item"><strong>Korean Cinema Today</strong><span>Special Premiere trae los estrenos recientes del cine coreano masivo; Panorama recorre la amplitud de esa cinematografía.</span></div>
                      <div class="section-glossary-item"><strong>World Cinema</strong><span>Cine contemporáneo más allá de Asia, con títulos premiados en otros festivales.</span></div>
                      <div class="section-glossary-item"><strong>Flash Forward</strong><span>Primeras y segundas películas de directores no asiáticos emergentes, con un premio votado por el público.</span></div>
                      <div class="section-glossary-item"><strong>Wide Angle</strong><span>Cortos y documentales en cuatro ramas: cortos coreanos, cortos asiáticos, competencia documental y muestra documental.</span></div>
                      <div class="section-glossary-item"><strong>Open Cinema</strong><span>Películas aclamadas y de alcance amplio, al aire libre en el Roof Theater del Cinema Center.</span></div>
                      <div class="section-glossary-item"><strong>Midnight Passion</strong><span>Nueve películas, tres por noche, a lo largo de tres noches.</span></div>
                      <div class="section-glossary-item"><strong>On Screen</strong><span>Las series más esperadas del año.</span></div>
                      <div class="section-glossary-item"><strong>In Focus</strong><span>Tres retrospectivas en esta edición: Ahn Sung-ki, la animación japonesa y Michelle Yeoh.</span></div>
                      <div class="section-glossary-item"><strong>Special Screenings &amp; Carte Blanche</strong><span>Películas elegidas por figuras invitadas del cine y la cultura, seguidas de una charla con el público.</span></div>
                    </div>
                  </template>
                  ...
                  <template v-if="infoSlide === 4">
                    <div class="carousel-card-header">
                      ...
                      <h3>Cómo leer la grilla</h3>
                    </div>
                    <div class="section-glossary">
                      <div class="section-glossary-item"><strong>ALL · 12 · 15 · 19</strong><span>Calificación coreana: apta para todo público, o prohibida para menores de 12, de 15 y de 19.</span></div>
                      <div class="section-glossary-item"><strong>KE</strong><span>Subtítulos en coreano e inglés, o diálogo en inglés.</span></div>
                      <div class="section-glossary-item"><strong>KN</strong><span>Subtítulos en coreano sobre diálogo que no está en inglés, y sin subtítulos en inglés.</span></div>
                      <div class="section-glossary-item"><strong>KK</strong><span>Subtítulos en coreano sobre diálogo en coreano.</span></div>
                      <div class="section-glossary-item"><strong>NO</strong><span>Sin diálogo.</span></div>
                      <div class="section-glossary-item"><strong>Sin marca</strong><span>Subtítulos en inglés sobre diálogo en coreano.</span></div>
                      <div class="section-glossary-item"><strong>GV</strong><span>Guest Visit: la función cuenta con un invitado. Puede cambiar sin aviso y no siempre hay interpretación al inglés.</span></div>
                      <div class="section-glossary-item"><strong>Función en tanda</strong><span>Varios cortos programados en un mismo pase. Cada uno figura acá con ese mismo horario.</span></div>
                    </div>
                    <p class="carousel-desc">No se permite entrar pasados los quince minutos de comenzada la función, y los menores de cuatro años no entran ni acompañados. Está prohibido fotografiar y grabar de principio a fin, avances y títulos finales incluidos.</p>
                  </template>
                </div>
              </transition>
            </div>
...
const CATEGORY_ORDER = [
    ...
    "Midnight Passion",
    "On Screen",
    "Special Program in Focus - Those Beautiful Years, Ahn Sung-ki",
    "Special Program in Focus - Japanese Animation Special: Masterpieces of Madness, Exhilarating Prospects 12+1",
    "Special Program in Focus - Everything Everywhere All for Michelle",
    "Special Screenings & Carte Blanche",
];

const CATEGORY_LABELS = {
    ["Opening Film"]: "Película inaugural",
    ["Gala Presentation"]: "Gala",
    ["Icons"]: "Icons",
    ["Competition"]: "Competencia",
    ["Vision – Korea"]: "Vision — Corea",
    ["Vision – Asia"]: "Vision — Asia",
    ["A Window on Asian Cinema"]: "Ventana al cine asiático",
    ["Korean Cinema Today — Special Premiere"]: "Cine coreano hoy — Estrenos",
    ["Korean Cinema Today — Panorama"]: "Cine coreano hoy — Panorama",
    ["World Cinema"]: "Cine del mundo",
    ["Flash Forward"]: "Flash Forward",
    ["Wide Angle - Korean Short Film Competition"]: "Wide Angle — Cortos coreanos",
    ["Wide Angle - Asian Short Film Competition"]: "Wide Angle — Cortos asiáticos",
    ["Wide Angle - Documentary Competition"]: "Wide Angle — Competencia documental",
    ["Wide Angle - Documentary Showcase"]: "Wide Angle — Muestra documental",
    ["Open Cinema"]: "Open Cinema",
    ["Midnight Passion"]: "Midnight Passion",
    ["On Screen"]: "On Screen",
    ["Special Program in Focus - Those Beautiful Years, Ahn Sung-ki"]: "En foco — Ahn Sung-ki",
    ["Special Program in Focus - Japanese Animation Special: Masterpieces of Madness, Exhilarating Prospects 12+1"]: "En foco — Animación japonesa",
    ["Special Program in Focus - Everything Everywhere All for Michelle"]: "En foco — Michelle Yeoh",
    ["Special Screenings & Carte Blanche"]: "Proyecciones especiales & Carta blanca",
    OTHER: "Otros",
};
...
// On Screen es el strand de series del festival: las filas viven con forma de
...
function withOnScreenAsTv(filmsData) {
    const results = (filmsData?.results || []).map((f) => {
        const key = String(f.category || f.section || '').trim();
        return key === 'On Screen' ? { ...f, media_type: 'tv' } : f;
    });
...
onMounted(async () => {
    try {
        ...
        films.value = withOnScreenAsTv(filmsData);
