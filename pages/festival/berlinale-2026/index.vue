    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.berlinale.de/en/home.html" target="_blank" class="hero-backdrop">
            <img 
              src="/berlinale_backdrop_2026_es.webp" 
        ...
        <div v-if="activeTab === 'schedule'" class="schedule-container">
            ...
            <div class="coming-soon-container">
                <div class="coming-soon-content">
                    ...
                    <h2>Programación Próximamente</h2>
                    <p>Las fechas y horarios específicos de las proyecciones se anunciarán a partir del 4 de febrero de 2026.</p>
                </div>
            </div>
        </div>
      </div>
