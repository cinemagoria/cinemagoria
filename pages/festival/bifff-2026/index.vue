    ...
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://www.bifff.net" target="_blank" class="hero-backdrop">
            <img 
              ref="backdropImgRef"
              src="/festivals/bifff/bifff_backdrop_2026_eng.webp" 
              alt="BIFFF Backdrop"
              ...
              <transition :name="slideDirection" mode="out-in">
                <div class="carousel-card" :key="infoSlide">
                  ...
                  <template v-if="infoSlide === 0">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">Opening &amp; Closing Film (drink included)</span><span class="price-value">€16 / €13*</span></li>
                      <li><span class="price-label">Films</span><span class="price-value">€13 / €10*</span></li>
                      <li><span class="price-label">Short Films (Belgian / European / Int'l)</span><span class="price-value">€15 / €12*</span></li>
                      <li><span class="price-label">Double Bill (ticket desk only)</span><span class="price-value">€22 / €20*</span></li>
                      <li><span class="price-label">The Night (4 films + breakfast)</span><span class="price-value">€35 / €31*</span></li>
                      <li><span class="price-label">The Little Night / Z Movie Night</span><span class="price-value">€16 / €13*</span></li>
                      <li><span class="price-label">Family Screenings (Children &lt;12)</span><span class="price-value">€5</span></li>
                    </ul>
                  </template>

                  <!-- Slide 1: Passes & Events -->
                  <template v-if="infoSlide === 1">
                    ...
                    <ul class="price-list">
                      <li><span class="price-label">High Five Pass (5 screenings)</span><span class="price-value">€55</span></li>
                      <li><span class="price-label">High Five Student (5 screenings)</span><span class="price-value">€30</span></li>
                      <li><span class="price-label">Kayak Pass (10 tickets)</span><span class="price-value">€110</span></li>
                      <li><span class="price-label">ABO 2026 Full Festival Pass</span><span class="price-value">€290</span></li>
                    </ul>
                    <p class="carousel-desc">Many free events: Animations, Expo, Chill Zone, Art Contest, Make-up Contest, Body Painting, Q&amp;A sessions, Participatifff Shorts, Award Ceremony, and Bal des Vampires (costume mandatory).</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <ul class="bullet-list">
                      <li>Discounts (*) available for unemployed, students, disabled, 65+</li>
                      <li>Discounts available on-site only (not online)</li>
                      <li>Seats are not numbered</li>
                      <li>Tickets are non-refundable and non-exchangeable</li>
                      <li>BIFFF Coins: €1.20 / coin</li>
                    </ul>
                    <div class="promo-box">
                      <span class="promo-tag">TICKETING</span>
                      <p>Presales: <strong>March 18, 2026</strong>. On-site ticketing opens 30 min before first screening.<br/>Location: <strong>Brussels Expo – Palais 10</strong>, Place de Belgique 1, 1020 Brussels.</p>
                    </div>
                  </template>
                </div>
              </transition>
