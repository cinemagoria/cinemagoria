          ...
          <div class="card-info">
                    ...
                    ></textarea>
                     <div class="privacy-toggle" @click.stop="editForm.is_public = !editForm.is_public">
                         <div class="privacy-option">
                             ...
                             <span :class="{ 'privacy-active': editForm.is_public }">Public</span>
                         </div>
                     </div>
             ...
             <template v-else>
                ...
                <div class="action-buttons">
                    <button @click.stop="deleteList(list)" class="action-btn delete-btn">Delete</button>
                    <button @click.stop="startEdit(list)" class="action-btn edit-btn">Edit</button>
                </div>
             </template>
          </div>
        </div>
