    ...
    <section class="spacing">
      ...
      <div v-if="activeTab === 'movies'" class="content-section">
        ...
        <div v-else-if="!moviesLoading" class="empty-state">
           ...
           <button v-if="hasActiveFilters" @click="clearAllFilters" class="clear-btn" style="margin-top: 20px; width: auto; padding: 10px 20px; display: inline-block;">Clear Filters</button>
        </div>
      </div>
    ...
    <div v-if="filtersModalVisible" class="modal-overlay" @click="closeFiltersModal">
      <div class="filters-modal" @click.stop>
        ...
        <div class="filters-content">
          ...
          <div class="filter-group">
            <label class="filter-label">Calificación IMDB</label>
            <div class="year-inputs">
              <input 
                type="number" 
          ...
          <div class="filter-group">
            <label class="filter-label">Votos IMDB</label>
            <div class="year-inputs">
              <input 
                type="number" 
