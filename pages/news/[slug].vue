  ...
  <div class="article-page">
    ...
    <div v-else-if="error || !article" class="article-error">
      <div class="error-container">
        ...
        <NuxtLink to="/news" class="btn-back">← Volver a Noticias</NuxtLink>
      </div>
    </div>
      ...
      <div class="article-inner">
        ...
        <header class="article-header">
          <div class="article-meta">
            <span class="meta-badge">Cinemagoria Noticias</span>
        ...
        <!-- Body (Markdown rendered) — Spanish -->
        ...
        <footer class="article-footer">
          <div class="footer-inner">
            <div class="footer-logo">
              ...
              <span>Cinemagoria Noticias</span>
            </div>
            <NuxtLink
...
.error-container p { color: #8888a8; margin-bottom: 24px; }
...
.meta-date { font-size: 0.85rem; color: #6868a0; }
...
/* ── Divider ─────────────────────────────────────────────────────── */
.article-divider { margin: 32px 0; display: flex; align-items: center; }
...
.article-body :deep(strong) { color: #e8e8ff; font-weight: 600; }
.article-body :deep(em) { color: #b0b0d8; }
...
.lang-link:hover { color: #a0a0d8; background: rgba(255,255,255,0.05); }
