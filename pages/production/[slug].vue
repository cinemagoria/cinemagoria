    ...
    <section class="spacing">
      ...
      <div v-if="activeTab === 'movies'" class="content-section">
        ...
        <div v-else-if="!moviesLoading" class="empty-state">
           ...
           <p v-else>No movies found for this production company.</p>
      ...
      <div v-if="activeTab === 'tvShows'" class="content-section">
        ...
        <div v-else-if="!tvShowsLoading" class="empty-state">
           ...
           <p v-if="hasActiveFilters">Try adjusting your filters to see more results.</p>
           <p v-else>No TV shows found for this production company.</p>
            <button v-if="hasActiveFilters" @click="clearAllFilters" class="clear-btn" style="margin-top: 20px; width: auto; padding: 10px 20px; display: inline-block;">Clear Filters</button>
        </div>
      </div>
    </section>
          ...
          <div class="filter-group">
            ...
            <div class="custom-select" @click="toggleGenreDropdown">
              <div class="select-display">
                <span class="selected-value">{{ selectedGenreName || 'All genres' }}</span>
