    ...
    <div v-else class="profile-container">
      ...
      <div class="profile-header">
        ...
        <div class="profile-identity">
          ...
          <div class="profile-stats">
            <span>
              <strong>{{ profile.followers_count === -1 ? '—' : profile.followers_count }}</strong> followers
            </span>
            <span>
              <strong>{{ profile.following_count === -1 ? '—' : profile.following_count }}</strong> following
            </span>
          </div>
          <button
      ...
      <div v-if="profile.privacy_lists && publicLists?.length" class="profile-section">
        <div class="section-header" @click="collapsedLists = !collapsedLists">
          <h2 class="section-title">Lists ({{ publicLists.length }})</h2>
          <button class="expand-btn" :aria-label="collapsedLists ? 'Expand' : 'Collapse'">
        ...
        <div v-show="!collapsedLists">
          ...
          <div v-if="totalListsPages > 1" class="pagination-controls">
            <button @click="prevListsPage" :disabled="listsPage === 1" class="pagination-btn">Previous</button>
            <span class="pagination-info">Page {{ listsPage }} of {{ totalListsPages }}</span>
            <button @click="nextListsPage" :disabled="listsPage === totalListsPages" class="pagination-btn">Next</button>
          </div>
        </div>
      </div>
      ...
      <div v-if="profile.privacy_reviews && publicReviews?.length" class="profile-section">
        <div class="section-header" @click="collapsedReviews = !collapsedReviews">
          <h2 class="section-title">Reviews ({{ publicReviews.length }})</h2>
          <button class="expand-btn" :aria-label="collapsedReviews ? 'Expand' : 'Collapse'">
        ...
        <div v-show="!collapsedReviews">
          ...
          <div v-if="totalReviewsPages > 1" class="pagination-controls">
            <button @click="prevReviewsPage" :disabled="reviewsPage === 1" class="pagination-btn">Previous</button>
            <span class="pagination-info">Page {{ reviewsPage }} of {{ totalReviewsPages }}</span>
            <button @click="nextReviewsPage" :disabled="reviewsPage === totalReviewsPages" class="pagination-btn">Next</button>
          </div>
        </div>
      </div>
